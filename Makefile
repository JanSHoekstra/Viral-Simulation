...
PATH_TO_EMCC=/usr/lib/emscripten/emcc
HEADER_FILES = canvas.h ChartJS_handler.h html_canvas.h simulation.h statistics_handler.h subject.h movement_strategy.hpp
SOURCE_FILES = ChartJS_handler.cpp html_canvas.cpp main.cpp simulation.cpp subject.cpp movement_strategy.cpp
